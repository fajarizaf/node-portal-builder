...
<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark" style="background:#212053">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3 p-4">
                <li class="nav-item">
                ...
                <li class="nav-item" style="margin-left:-5px">
                    <a class="nav-link" href="#">
                        <span class="nav-link-title" style="color:#fff;font-size:12px;">
                            Toko
                        </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ URL('/manage/site') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ URL('/manage/site') }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-freeze-column">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path d="M9 9.5l-6 6" />
                                <path d="M9 4l-6 6" />
                                <path d="M9 15l-5 5" />
...
<header class="navbar navbar-expand-md d-print-none" data-bs-theme="light">
    <div class="container-xl" style="justify-content:flex-start">
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-menu" aria-controls="navbar-menu" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <h3 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
                <img src="{{ URL::asset('/assets/static/logo.png') }}" class="navbar-brand-image" />

            </a>
        </h3>
        <span class="badge bg-yellow text-yellow-fg" style="margin-right:15px;">Dashboard</span>
